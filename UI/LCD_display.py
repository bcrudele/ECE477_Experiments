...
puck_position = (150, 120)  # Example puck position (x, y)
frame_rate = 30  # Example frame rate in FPS
battery_level = 85  # Example battery level in percentage
...
def update_gui():
    ...
    #display.fill_rectangle(puck_position[0], puck_position[1], puck_position[0],puck_position[1], color=ili934x.color565(255,255,255))
    # Display frame rate
